...
def runPipeline(catalog = 0):
    ...
    start = time.time()
    with noprint():
        stack.stackCores(catalog=catalog, process=True)
    end = time.time()
    print('done; took {} s'.format(end-start))
    ...
    start = time.time()
    with noprint():
        analyze.segregation_cores(catalog=catalog, process=True)
    end = time.time()
    print('done; took {} s'.format(end-start))
    ...
    start = time.time()
    with noprint():
        analyze.segregation_binning(catalog=catalog, process=True)
    end = time.time()
    print('done; took {} s'.format(end-start))

    endProcessed = time.time()
    print('processed cores have gone through entire pipeline; took {} s'
          .format(endProcessed - starProcessed))
    ...
    start = time.time()
    with noprint():
        stack.stackCores(catalog=catalog, process=False)
    end = time.time()
    print('done; took {} s'.format(end-start))
    ...
    start = time.time()
    with noprint():
        analyze.segregation_cores(catalog=catalog, process=False)
    end = time.time()
    print('done; took {} s'.format(end-start))
    ...
    start = time.time()
    with noprint():
        analyze.segregation_binning(catalog=catalog, process=False)
    end = time.time()
    print('done; took {} s'.format(end-start))
