...
def allTests(lcDir_interp, lcDir_extrap, snapshotDir, histFigDir, trajectoryDir, trajectoryPlotDir, 
    ...
    vt.compareDuplicates(duplicateDir, steps=allSteps, 
    ...
    vt.comvDist_vs_z([lcDir_interp, lcDir_extrap], steps=[487, 475, 464, 453, 442], plotMode='save',
...
def particles_reversed():
    ...
    allTests(lcDir_interp='/projects/DarkUniverse_esp/jphollowed/alphaQ/lightcone_downsampled_octant_backward', 
             ...
             snapshotDir='/projects/DarkUniverse_esp/heitmann/OuterRim/M000/L360/HACC001/analysis/Particles', 
             histFigDir='/home/hollowed/lc_reversed_validation/hists', 
             trajectoryDir='/home/hollowed/lc_reversed_validation/trajData', 
             trajectoryPlotDir='/home/hollowed/lc_reversed_validation/trajPlots', 
             duplicateDir='/home/hollowed/lc_reversed_validation/duplData' ,
             duplicatePlotDir='/home/hollowed/lc_reversed_validation/duplPlots', 
             replicationPlotDir='/home/hollowed/lc_reversed_validation/replPlots', 
             comvDist_vs_redshift_PlotDir='/home/hollowed/lc_reversed_validation/comvDist_z_plots', 
             pmode='particles', 
             snapSubdirs=True, 
             plotMode='save', 
             cmap=None)
